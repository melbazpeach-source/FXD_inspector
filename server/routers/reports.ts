...
<div class="header">
  ...
  <div class="subtitle">Inspect360 — Professional Property Inspection Platform</div>
</div>
...
<div class="footer">
  <p>Report generated by Inspect360 on ${new Date().toLocaleDateString("en-NZ", { year: "numeric", month: "long", day: "numeric" })} at ${new Date().toLocaleTimeString("en-NZ")}</p>
